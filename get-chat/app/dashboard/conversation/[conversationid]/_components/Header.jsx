    ...
    >
      <div className="flex items-center gap-2">
        ...
        <div className=" flex flex-col">
          <h1
            className="font-semibold text-2xl truncate text-white h-fit "
          >
            {selectedFriend?.username}
          </h1>
          <span className="text-[0.65rem] h-fit text-white animate-pulse">{onlineFriends.includes(selectedFriend?._id) ? "online" : ''}</span>
        </div>
      </div>
    </Card>
  );
